settings = dict(
    structure=dict(
        ...
        x_coupling=.8,  # nu_x, x (parallel) coupling
        yz_coupling=0.13,  # nu_yz, yz (perpendicular) coupling
        ...
        # Use read_af_pos_data() in risk_curve_data_plotter.py to generate data
    ...
    view="gauss_filter"  # "gauss_filter", "expt", or "max_gauss"
)
