...
structural_homogeneity = .1  # Probability of transverse connections
dysfunction_parameter = .2  # Fraction of dysfunctional cells
dysfunction_probability = .2
substrate_size = (200, 200,30)
